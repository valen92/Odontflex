...
public class NotaEvolucionCrear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nota_evolucion_crear);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nota_evolucion_crear, menu);
        return true;
    }
    ...
    class insertar extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String feed) {
            Toast.makeText(getApplicationContext(), "Nota de evolución insertada con exito", Toast.LENGTH_LONG).show();
        }
    }
}
