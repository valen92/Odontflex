...
public class HistoriaClinicaAlergiasHabitos extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_historia_clinica_alergias_habitos, menu);
        return true;
    }
    ...
    class insertar extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            datos.add(new BasicNameValuePair("op", "habitos"));
        ...
        protected void onPostExecute(String feed) {
            Toast.makeText(getApplicationContext(), "Insertado con exito habitos", Toast.LENGTH_LONG).show();
  ...
  class insertar2 extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            datos.add(new BasicNameValuePair("op", "alergias"));
