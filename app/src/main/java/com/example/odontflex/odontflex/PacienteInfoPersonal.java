...
public class PacienteInfoPersonal extends AppCompatActivity {
    ...
    public void fecha() {
        ...
        DatePickerDialog myDatePiccker = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year1, int month1, int day2) {
                ...
                txtApePaciente.setEnabled(false);
    ...
    class actualizar extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            datos.add(new BasicNameValuePair("op", "actualizarinfoGeneral"));
        ...
        protected void onPostExecute(String feed) {
            Toast.makeText(getApplicationContext(), "Se ha actualizado la información con exito", Toast.LENGTH_LONG).show();
        }
    }
}
